            ...
            <div className="vendor-sign-container d-md-flex">
                ...
                <div className="vendor-sign-content col-md-6 px-3 px-lg-5 d-flex flex-column align-items-center justify-content-center" style={{ background: '#edeaf2' }}>
                    ...
                    <form className='d-flex flex-wrap justify-content-between align-items-center w-100'>
                        ...
                        <div className="input-field">
                            <label className='text-start w-100 mb-2 text-dark'>Phone No.<strong style={{ color: 'red' }}>*</strong></label>
                            <input type="number" value={phone} placeholder='Phone Number' onChange={handlePhone} style={{ border: errors.email ? '1px solid red' : '1px solid black' }} />
                        </div>
                    ...
                    <h5 className='mb-5 fw-normal '><Link to='/signup' className='fw-bold'>Sign Up</Link> as Influencer</h5>
                </div>
            </div>
        </div>
    )
