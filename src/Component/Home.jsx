        ...
        <div className='influncer-info'>
          <div className="container">
            ...
            {influencer.map((item, i) => (
                 ...
                 <div className={`influncer-info-with ${i == 1 ? 'orangebox' : 'sky' }`}>
                   <div className='img-infulcer'>
                     <img src={item.image}></img>
                   </div>
                   <div className='name-influ'>{item.fullname}</div>
                   <div className='border-influ'></div>
                   <div className='count-flowers'>{item.follower} Followers</div>
                    <p className='text-center m-0'>
                      {item.influencerid_id__facility !== null && item.influencerid_id__facility !== '' ? item.influencerid_id__facility : '-'}
                    </p>
                   <div class="cam-price social-price">AED {item.influencerid_id__fee}</div>
